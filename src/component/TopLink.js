...
// const buttons = [NearMeRoundedIcon,ApartmentIcon,SpokeRoundedIcon];
const pages = ['FİRMALAR', 'ATÖLYELER', 'İLANDAKİ İŞLER'];
  ...
  return (
    ...
    <Container maxWidth="xl">
      <Toolbar disableGutters>
        <CurrencyLiraIcon sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} />
        <Typography
          variant="h6"
          noWrap
          component="a"
